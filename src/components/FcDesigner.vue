        ...
        <el-main>
            <el-container style="height: 100%;" :key="locale && locale.name">
                <el-aside class="_fc-l-menu" v-show="!hiddenLeft" width="40px"
                    ...
                    <el-tooltip v-if="getConfig('showJsonPreview', true)" effect="dark" content="JSON" placement="right"
                        :hide-after="0">
                                        ...
                                        <div class="_fc-tree-label">
                                            ...
                                            <span>{{
                                                (data.rule?.__fc__?.refRule?.__$title?.value || data.rule.title ||
                                                    '').trim() || (data.rule.props && data.rule.props.label) || t('com.' +
                                                        (data.rule._menu && data.rule._menu.name) + '.name') || (data.rule._menu
                        ...
                        <div class="_fc-m-drag" :class="device" ref="dragCon"
                            ...
                            <div class="_fc-m-input" v-if="inputForm.state">
                                <ViewForm :key="inputForm.key" :rule="inputForm.rule" :option="inputForm.option"
                                    :locale="locale?.name" v-model:api="inputForm.api" :disabled="false"></ViewForm>
                ...
                <el-aside class="_fc-r" width="320px" v-show="!hiddenRight"
                        ...
                        <el-main class="_fc-r-tab-props" v-show="activeTab === 'props'"
                            ...
                            <template
                                ...
                                <template
                                    ...
                                    <el-input size="small" class="_fc-r-name-input" v-model.trim="activeRule.name"
                            ...
                            <div class="_fc-r-config" :style="{ 'grid-template-areas': configFormOrderStyle }">
                                ...
                                <div style="grid-area: props;">
                                    ...
                                    <DragForm v-show="propsForm.isShow" v-model:api="propsForm.api"
                                        :rule="propsForm.rule" :option="propsForm.options" :modelValue="propsForm.value"
                                    ...
                                    <DragForm v-if="customForm.isShow && customForm.propsShow"
                                        ...
                                        :option="customForm.options" :key="customForm.key" @change="customFormChange">
                                    </DragForm>
                                </div>
                                <div style="grid-area: style;">
                                    ...
                                    <DragForm v-show="styleForm.isShow" :rule="styleForm.rule"
                                        :option="styleForm.options" :modelValue="styleForm.value" @change="styleChange"
                                        v-model:api="styleForm.api"></DragForm>
                                </div>
